...
@Component({
  selector: 'app-addoreditKhuyenMai',
  templateUrl: './addoreditKhuyenMai.component.html',
  styleUrl: './addoreditKhuyenMai.component.scss'
})
...
// Form data model
  ...
  constructor(
    public dialogRef: MatDialogRef<AddoreditKhuyenMaiComponent>,
