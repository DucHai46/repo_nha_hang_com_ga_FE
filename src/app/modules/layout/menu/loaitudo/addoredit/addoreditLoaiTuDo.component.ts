...
@Component({
  selector: 'app-addoreditLoaiTuDo',
  templateUrl: './addoreditLoaiTuDo.component.html',
  styleUrl: './addoreditLoaiTuDo.component.scss'
})
export class AddoreditLoaiTuDoComponent {
// Form data model
  formData = {
    tenLoai: '',
    moTa: '',
  ...
  constructor(
    public dialogRef: MatDialogRef<AddoreditLoaiTuDoComponent>,
