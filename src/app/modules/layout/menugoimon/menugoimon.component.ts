...
export class MenugoimonComponent {
  ...
  itemsMonAn = [
    // Đồ uống
    { ma: 'MON-001', ten: 'Trà đá', hinhAnh: 'https://via.placeholder.com/150', gia: 12000, soLuong: 0, danhMuc: 'DM-002' },
    { ma: 'MON-002', ten: 'Bình trà đá (Lớn)', hinhAnh: 'https://via.placeholder.com/150', gia: 35000, soLuong: 0, danhMuc: 'DM-002' },
    { ma: 'MON-003', ten: 'Coca', hinhAnh: 'https://via.placeholder.com/150', gia: 15000, soLuong: 0, danhMuc: 'DM-002' },
    ...
    // Món khai vị
    { ma: 'MON-007', ten: 'Khoai tây chiên (S)', hinhAnh: 'https://via.placeholder.com/150', gia: 35000, soLuong: 0, danhMuc: 'DM-005' },
    { ma: 'MON-008', ten: 'Khoai tây chiên (L)', hinhAnh: 'https://via.placeholder.com/150', gia: 59000, soLuong: 0, danhMuc: 'DM-005' },
    ...
    // Các món chính
    { ma: 'MON-011', ten: 'Cơm gà Hải Nam', hinhAnh: 'https://via.placeholder.com/150', gia: 65000, soLuong: 0, danhMuc: 'DM-008' },
    ...
    // Combo
    { ma: 'MON-015', ten: 'Combo 1 người', hinhAnh: 'https://via.placeholder.com/150', gia: 90000, soLuong: 0, danhMuc: 'DM-003' },
